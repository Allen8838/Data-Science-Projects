...
if __name__ == "__main__":
    ...
    df_prcsd = jn_df_n_rmv_empty_rws(dataframe_test_samples, dataframe_trans_data, 'sample_id')
    ...
    tst_groupby_smpl_id, ctrl_groupby_smpl_id = group_sample_id_n_col(REBILL_tst_grp, REBILL_ctrl_grp,
    ...
    trans_amt_tst, trans_amt_ctrl = group_sample_id_n_col(trans_amt_tst,
                                                          trans_amt_ctrl,
                                                          'sample_id',
                                                          'transaction_amount')
