...
def execute_procedure_for_question_1(csv_file):
    #variables used
    ...
    df = pd.read_csv(csv_file, names=['time', 'message_id', 'sender', 'recipients', 'topic', 'mode'])
...
if __name__ == "__main__":
    csv_file = sys.argv[1]
    list_of_top_five_senders, dict_senders_number_msgs_per_time, list_of_senders_time, dataframe_from_parse_recipients = execute_procedure_for_question_1(csv_file)
